...
module.exports = async function (argv) {
  ...
  if (info.options.argv.remain[0] !== 'setup' && info.options.argv.remain[0] !== 'init' || info.options.help) { // eslint-disable-line no-mixed-operators
    console.log(`
semantic-sf-cli
...
Aliases:
  ...
  pkg.scripts['sf-release'] = 'semantic-release pre && semantic-release genlog && scriptfodder-publish && semantic-release post'
